...
@Component({
  selector: 'app-seguros-pendientes-captura',
  templateUrl: './seguros-pendientes-captura.component.html',
  styleUrls: ['./seguros-pendientes-captura.component.css'],
  providers: [
    {
      provide: DateAdapter,
...
export class SegurosPendientesCapturaComponent implements OnInit {
