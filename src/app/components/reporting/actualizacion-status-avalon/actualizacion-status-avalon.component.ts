...
@Component({
  selector: 'app-actualizacion-status-avalon',
  templateUrl: './actualizacion-status-avalon.component.html',
  styleUrls: ['./actualizacion-status-avalon.component.css'],
  providers: [
    {
      provide: DateAdapter,
...
export class ActualizacionStatusAvalonComponent implements OnInit {
